...
>The density of sat increase as sat increase, then decrease after sat reachs 900, it increase and decrease again. There are two peaks in this plot.
...
There are three smooth line in the plot that represent 3 different range of expend. 
...
As expend increase, the sat score decrease, and the sat also decrease as the salary decrease.
...
>The state that under 15% take the SAT would have higher grades, but at least 45% take the SAT would have lower grade.
