...
```{r}
library(tidyverse)
imdb_messy <- read_csv("~/Desktop/大三下/Stat 112/portfolio-Lucia040111/data/imdb_5000_messy.csv")
```
...
-   What type of info is provided on quantitative variables?minimum, maximum, mean...
-   What type of info is provided on categorical variables? names of different object in categories.
...
-   What's goofy about this / what do we need to fix? Many cells have "color" as filling
